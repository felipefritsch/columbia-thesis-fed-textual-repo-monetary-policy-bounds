...
\paragraph{Outline.} Section~\ref{sec:literature} reviews the related literature, including work published since
the first version of this thesis. Section~\ref{sec:data} describes the FOMC's decision process and the construction
of the policy menus. Section~\ref{sec:framework} sets out the framework and derives the bounds.
Section~\ref{sec:estimation} covers estimation and inference, and Section~\ref{sec:results} reports results.
Section~\ref{sec:discussion} discusses them in light of recent work, and Section~\ref{sec:conclusion} concludes.
